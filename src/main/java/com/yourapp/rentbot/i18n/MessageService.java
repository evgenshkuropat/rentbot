...
public class MessageService {
    ...
    public MessageService() {
        ...
        Map<String, String> ua = Map.ofEntries(
                ...
                Map.entry("layout.choose", "Обери тип квартири:"),
        ...
        Map<String, String> ru = Map.ofEntries(
                ...
                Map.entry("layout.choose", "Выберите тип квартиры:"),
        ...
        Map<String, String> cz = Map.ofEntries(
                ...
                Map.entry("layout.choose", "Vyber typ bytu:"),
        ...
        Map<String, String> en = Map.ofEntries(
                ...
                Map.entry("layout.choose", "Choose apartment type:"),
